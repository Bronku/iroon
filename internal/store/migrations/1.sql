...
create
virtual table order_fts using fts5 (
    id,
    name,
    surname,
    phone,
...
create trigger order_fts_insert
    after insert
    on customer_order
begin
    insert into order_fts (id,
                           name,
                           surname,
                           phone,
                           location,
...
create trigger order_fts_delete
    after delete
    on customer_order
begin
    delete
...
create trigger order_fts_update
    after
        update
    on customer_order
begin
